            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('expenses.index', $colocation) }}"
                        class="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-6 py-2.5 rounded-2xl font-bold transition shadow-sm flex items-center gap-2">
